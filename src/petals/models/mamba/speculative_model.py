...
from petals.models.mamba.model import DistributedMambaForCausalLM


class DistributedMambaForSpeculativeGeneration(DistributedMambaForCausalLM, GenerationMixin):
    def __init__(self, config: DistributedMambaConfig, small_model: MambaForCausalLM):
        DistributedMambaForCausalLM.__init__(self, config)
